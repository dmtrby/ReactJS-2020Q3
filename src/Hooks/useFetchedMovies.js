...
const mockedMoviesData = [
  ...
  },
  {
    ...
    year: '1995',
    description:
      'Six criminals, hired to steal diamonds, do not know each others true identity. While attempting the heist, the police ambushes them, leading them to believe that one of them is an undercover officer.',
    duration: '112',
    rating: '7.5',
    url: 'google.com',
  },
